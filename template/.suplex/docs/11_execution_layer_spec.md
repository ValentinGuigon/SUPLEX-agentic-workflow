...
If the pass updates closeout state such as `./.suplex/handoffs/active/current_handoff.md`, `./.suplex/phases/active/current_phase.md`, or checkpoint docs that imply completion, the execution layer must still ensure the required report artifact is written before claiming success.
