...
This file is the portable supervision packet for Aurora Forecast Notes when the supervisor does not have direct repository access.
...
- Project: `Aurora Forecast Notes`
- Purpose: bounded control-layer governance for an aurora-summary repository
...
- Bootstrap supervision and define the first bounded task for Aurora Forecast Notes. [E]
