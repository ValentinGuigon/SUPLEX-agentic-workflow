...
- [E] The control layer was added without creating computation or publication scaffolding.
...
- [E] Rewrote `docs/00_project_scope.md`, `docs/08_status_checkpoint.md`, and `docs/09_supervision_brief.md` so they describe Aurora Forecast Notes rather than `suplex-template`.
