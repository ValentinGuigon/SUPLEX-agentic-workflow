...
2. bootstrap supervision using the canonical control docs and init state
3. determine the minimum required reconstruction level for the first decision
4. identify or draft the first active bounded handoff
5. issue the first execution prompt only after supervision has defined scope
