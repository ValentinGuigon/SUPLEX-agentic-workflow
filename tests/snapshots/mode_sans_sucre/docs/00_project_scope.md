...
Mode Sans Sucre`n`nSans-sucre mode validation target. is the target repository for SUPLEX initialization. [E]

## SUPLEX layer scope

- establish repo-local governance for bounded agentic work [E]
- establish canonical control-memory docs for this target repo [E]
...
- modeling, data, notebook, pipeline, publication, or deployment scaffolding [E]
...
- `sans-sucre` workflow infrastructure was installed during initialization. [E]
