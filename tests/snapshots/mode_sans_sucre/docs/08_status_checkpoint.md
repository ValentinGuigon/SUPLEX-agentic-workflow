...
- [E] The installed workflow infrastructure mode is `sans-sucre`.
...
- [E] Rewrote `docs/00_project_scope.md`, `docs/01_source_of_truth_and_provenance.md`, `docs/08_status_checkpoint.md`, and `docs/09_supervision_brief.md` so they describe Mode Sans Sucre`n`nSans-sucre mode validation target. rather than `suplex-template`.
