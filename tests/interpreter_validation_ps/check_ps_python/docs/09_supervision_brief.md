...
This file is the portable supervision packet for check_ps_python when the supervisor does not have direct repository access.
...
- Project: `check_ps_python`
- Purpose: check_ps_python is the target repository for SUPLEX initialization.
...
- Bootstrap supervision and define the first bounded task for check_ps_python. [E]
