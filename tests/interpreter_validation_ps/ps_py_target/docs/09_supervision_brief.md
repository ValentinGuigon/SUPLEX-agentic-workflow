...
This file is the portable supervision packet for ps_py_target when the supervisor does not have direct repository access.
...
- Project: `ps_py_target`
- Purpose: ps_py_target is the target repository for SUPLEX initialization.
...
- Bootstrap supervision and define the first bounded task for ps_py_target. [E]
