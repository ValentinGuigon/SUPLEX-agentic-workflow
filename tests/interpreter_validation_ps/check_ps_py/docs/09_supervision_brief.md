...
This file is the portable supervision packet for check_ps_py when the supervisor does not have direct repository access.
...
- Project: `check_ps_py`
- Purpose: check_ps_py is the target repository for SUPLEX initialization.
...
- Bootstrap supervision and define the first bounded task for check_ps_py. [E]
